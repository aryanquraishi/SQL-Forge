  ...
  ({ placeholder = "Type your message...", onSubmit, onChange, onFileUpload, disabled = false, className }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex w-full items-center gap-2 rounded-lg border border-input bg-background px-3 py-2 shadow-sm focus-within:border-primary focus-within:ring-1 focus-within:ring-primary",
          className
        )}
      >
                <Button
